...
<body>
    ...
    <br/>
    <a class="tombol" href="input-pelanggan.php">+ Tambah Pelanggan Baru</a>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><?php echo $data['pass_customer']; ?></td>
            
            <td>
                <a class="edit" href="edit-customer.php?id=<?php echo $data['id_customer']; ?>">Edit</a> |
                <a class="hapus" href="hapus-customer.php?id=<?php echo $data['id_customer']; ?>">Hapus</a>
            </td>
        </tr>
        <?php 
            } 
        } else {
            echo "<tr><td colspan='9'>Tabel customer belum dibuat atau masih kosong</td></tr>";
        }
        ?>
    </table>
</body>
